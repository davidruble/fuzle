...
public:
	// Return -1 on failure
	static constexpr float FAILURE = -1.0f;
...
private:
	...
	// subchunk2Size
	static constexpr int COMP_PAD = 2;
	...
	static constexpr int HEADER_SIZE_BYTES = sizeof(XwmaHeader) - COMP_PAD - sizeof(unsigned long*);
